...
//   const [logoFiles, setLogoFiles] = useState<(File | null)[]>([null, null, null, null]);
...
//   const handleLogoChange = (index: number, event: React.ChangeEvent<HTMLInputElement>) => {
//     if (event.target.files && event.target.files[0]) {
//       const file = event.target.files[0];
//       const newLogoFiles = [...logoFiles];
//       newLogoFiles[index] = file;
//       setLogoFiles(newLogoFiles);

//       // Create preview URL
//       const newLogo = URL.createObjectURL(file);
//       handleSponsorChange(index, 'logo', newLogo);
//     }
//   };
...
//       alert('Error saving sponsors. Please try again.');
//     }
//   };
...
//         <h2 className="text-2xl font-bold text-white mb-6">Sponsors Management</h2>

//         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
//           {sponsors.map((sponsor, index) => (
//             <div
//               key={index}
//               className="bg-white/5 backdrop-blur-sm p-6 rounded-lg relative"
//             >
//               <button
...
//                     onChange={(e) =>
//                       handleSponsorChange(index, 'website', e.target.value)
//                     }
//                     className="w-full bg-white/10 border border-gray-600 rounded-lg px-4 py-2 text-white"
//                   />
//                 </div>

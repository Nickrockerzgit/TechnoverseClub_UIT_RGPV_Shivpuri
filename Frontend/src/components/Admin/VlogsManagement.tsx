...
//         resolve(duration <= 1500); // 25 minutes in seconds
//       };
...
//   const handleVlogChange = (index: number, field: string, value: string | File) => {
...
//   const handleAddVlog = () => {
//     setVlogs([...vlogs, { title: 'New Vlog', video: null, thumbnail: null }]);
//   };
...
//     setLoading(true);
//     try {
//       const validVlogs = vlogs.filter((vlog) => vlog.video && vlog.thumbnail);

//       if (validVlogs.length === 0) {
//         alert('Please add video and thumbnail for at least one vlog');
//         setLoading(false);
//         return;
//       }
...
//       setVlogs([{ title: 'New Vlog', video: null, thumbnail: null }]);
//       fetchVlogs();
//     } catch (error) {
...
//   return (
//     <div ref={vantaRef} className="relative h-full-screen p-10 text-white">
...
//                 />
//                 {(vlog.thumbnailUrl || vlog.thumbnail) && (
//                   <img
//                     src={vlog.thumbnail ? URL.createObjectURL(vlog.thumbnail) : vlog.thumbnailUrl}
//                     alt="Thumbnail"
...
//                   className="w-full text-white"
//                 />
//                 {(vlog.videoUrl || vlog.video) && (
//                   <div className="mt-2">
//                     <video controls className="w-full h-48 object-cover rounded-lg">
//                       <source
//                         src={vlog.video ? URL.createObjectURL(vlog.video) : vlog.videoUrl}
//                         type="video/mp4"
//                       />
